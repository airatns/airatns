...
* <a href="https://github.com/airatns/infra_sp2" target="_blank">Docker</a> for the YaMDb. I have built Docker container actions and deployed the application in separate containers.
